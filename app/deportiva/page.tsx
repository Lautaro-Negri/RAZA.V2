...
export default function DeportivaPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      document.getElementById("identificacion-solicitante")?.scrollIntoView({ behavior: "smooth", block: "center" });
    }, 350);
            ...
            <div className="flex flex-col gap-8 w-full"> 
              ...
              <div className="bg-[#050505] border border-gray-900 p-6 md:p-8 w-full">
                <h3 className="text-white font-black text-sm tracking-[0.4em] uppercase italic mb-6 border-b border-gray-900 pb-4">
                  // CONFIGURACIÓN DEL <span className="text-[#D70000]">SET</span> <span className="text-gray-500 font-normal text-xs tracking-normal">(seleccionar que prendas quiere)</span>
                </h3>
