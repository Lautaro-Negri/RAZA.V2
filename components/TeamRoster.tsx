...
export default function TeamRoster({ selectedLine, selectedKit }: { selectedLine: string, selectedKit: string[] }) {
  ...
  // Datos de ejemplo para las 10 unidades iniciales
  const examplePlayers: Player[] = [
    { id: crypto.randomUUID(), name: "", number: "", sizes: {} },
    { id: crypto.randomUUID(), name: "", number: "", sizes: {} },
    { id: crypto.randomUUID(), name: "", number: "", sizes: {} },
    { id: crypto.randomUUID(), name: "", number: "", sizes: {} },
    { id: crypto.randomUUID(), name: "", number: "", sizes: {} },
  ...
  const [players, setPlayers] = useState<Player[]>(examplePlayers);
  ...
  return (
    <div className="flex flex-col gap-8 w-full animate-in fade-in duration-700">
      ...
      <div id="identificacion-solicitante" className="bg-[#050505] border border-gray-900 p-6 md:p-8 scroll-mt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <input 
            ...
            className="bg-black border border-gray-800 p-4 text-[10px] font-mono text-white focus:border-[#D70000] outline-none transition-all placeholder:text-gray-400"
          />
          <input 
            type="text" 
      ...
      <div id="listado-unidades" className="bg-[#050505] border border-gray-900 p-6 md:p-8 overflow-hidden scroll-mt-24">
                ...
                <tr key={player.id} className="border-b border-gray-800/40 hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="p-2">
                    <input 
                      ...
                      className="bg-transparent border-b border-gray-900 w-full p-2 text-white focus:border-[#D70000] outline-none uppercase placeholder:text-gray-400"
                    />
                  </td>
                  <td className="p-2">
                    <input 
